...
export type Lang = 'nl' | 'en' | 'de' | 'pl' | 'fr';

export const SUPPORTED_LANGS: Lang[] = ['nl', 'en', 'de', 'pl', 'fr'];
...
const WEATHER_LABELS: Record<WeatherKey, Record<Lang, string>> = {
  clear: { nl: 'Onbewolkt', en: 'Clear', de: 'Klar', pl: 'Bezchmurnie', fr: 'Dégagé' },
  mostlyClear: { nl: 'Vrijwel onbewolkt', en: 'Mostly clear', de: 'Überwiegend klar', pl: 'Prawie bezchmurnie', fr: 'Plutôt dégagé' },
  partlyCloudy: { nl: 'Half bewolkt', en: 'Partly cloudy', de: 'Teils bewölkt', pl: 'Częściowe zachmurzenie', fr: 'Partiellement nuageux' },
  cloudy: { nl: 'Bewolkt', en: 'Cloudy', de: 'Bewölkt', pl: 'Pochmurno', fr: 'Nuageux' },
  fog: { nl: 'Mist', en: 'Fog', de: 'Nebel', pl: 'Mgła', fr: 'Brouillard' },
  lightDrizzle: { nl: 'Lichte motregen', en: 'Light drizzle', de: 'Leichter Nieselregen', pl: 'Lekka mżawka', fr: 'Légère bruine' },
  drizzle: { nl: 'Motregen', en: 'Drizzle', de: 'Nieselregen', pl: 'Mżawka', fr: 'Bruine' },
  denseDrizzle: { nl: 'Dichte motregen', en: 'Dense drizzle', de: 'Dichter Nieselregen', pl: 'Gęsta mżawka', fr: 'Bruine dense' },
  freezingDrizzle: { nl: 'IJzel', en: 'Freezing drizzle', de: 'Gefrierender Nieselregen', pl: 'Marznąca mżawka', fr: 'Bruine verglaçante' },
  lightRain: { nl: 'Lichte regen', en: 'Light rain', de: 'Leichter Regen', pl: 'Lekki deszcz', fr: 'Pluie légère' },
  rain: { nl: 'Regen', en: 'Rain', de: 'Regen', pl: 'Deszcz', fr: 'Pluie' },
  heavyRain: { nl: 'Zware regen', en: 'Heavy rain', de: 'Starker Regen', pl: 'Silny deszcz', fr: 'Forte pluie' },
  freezingRain: { nl: 'IJsregen', en: 'Freezing rain', de: 'Gefrierender Regen', pl: 'Marznący deszcz', fr: 'Pluie verglaçante' },
  lightSnow: { nl: 'Lichte sneeuw', en: 'Light snow', de: 'Leichter Schnee', pl: 'Lekki śnieg', fr: 'Légère neige' },
  snow: { nl: 'Sneeuw', en: 'Snow', de: 'Schnee', pl: 'Śnieg', fr: 'Neige' },
  heavySnow: { nl: 'Hevige sneeuw', en: 'Heavy snow', de: 'Starker Schnee', pl: 'Intensywny śnieg', fr: 'Forte neige' },
  snowGrains: { nl: 'Sneeuwkorrels', en: 'Snow grains', de: 'Schneegriesel', pl: 'Ziarna śniegu', fr: 'Grains de neige' },
  lightShowers: { nl: 'Lichte buien', en: 'Light showers', de: 'Leichte Schauer', pl: 'Lekkie przelotne opady', fr: 'Légères averses' },
  showers: { nl: 'Buien', en: 'Showers', de: 'Schauer', pl: 'Przelotne opady', fr: 'Averses' },
  heavyShowers: { nl: 'Zware buien', en: 'Heavy showers', de: 'Starke Schauer', pl: 'Silne przelotne opady', fr: 'Fortes averses' },
  snowShowers: { nl: 'Sneeuwbuien', en: 'Snow showers', de: 'Schneeschauer', pl: 'Przelotne opady śniegu', fr: 'Averses de neige' },
  thunder: { nl: 'Onweer', en: 'Thunderstorm', de: 'Gewitter', pl: 'Burza', fr: 'Orage' },
  thunderHail: { nl: 'Onweer met hagel', en: 'Thunderstorm with hail', de: 'Gewitter mit Hagel', pl: 'Burza z gradem', fr: 'Orage avec grêle' },
  variable: { nl: 'Wisselvallig', en: 'Changeable', de: 'Wechselhaft', pl: 'Zmiennie', fr: 'Variable' },
};
...
const ROSE_FULL: Record<Lang, string[]> = {
  ...
  fr: ['nord', 'nord-nord-est', 'nord-est', 'est-nord-est', 'est', 'est-sud-est', 'sud-est', 'sud-sud-est', 'sud', 'sud-sud-ouest', 'sud-ouest', 'ouest-sud-ouest', 'ouest', 'ouest-nord-ouest', 'nord-ouest', 'nord-nord-ouest'],
};
...
export const STRINGS: Record<Lang, Strings> = {
  ...
  fr: {
    htmlLang: 'fr',
    weer: 'Météo',
    metaTitle: (n) => `Météo à ${n}`,
    updated: (t) => `actualisé ${t}`,
    feelsLike: (t) => `Ressenti ${t}°`,
    todayRange: (min, max) => `aujourd'hui ${min}° / ${max}°`,
    precipRate: (mm) => `💧 ${mm} mm/h`,
    verdictTop: 'Temps idéal pour sortir !',
    verdictMid: 'Temps moyen pour sortir',
    verdictBad: 'Pas un temps pour sortir',
    verdictSubDry: (t, bft) => `${t}° · ${bft} Bft · sec`,
    verdictSubRain: (t, bft, mm) => `${t}° · ${bft} Bft · ${mm} mm en journée`,
    windTitle: '💨 Vent',
    windFrom: (short, full, deg) => `Du ${short} (${full}, ${deg}°)`,
    windSpeed: (ms, km) => `${ms} m/s · ${km} km/h`,
    windGust: (km) => `Rafales jusqu'à ${km} km/h`,
    windRatingCalm: '🚴 Parfait pour le vélo et la marche',
    windRatingNice: '🚴 Temps agréable pour sortir',
    windRatingStrong: '💨 Vent fort — attention au vent de face',
    windRatingTooHard: '⚠️ Trop fort pour la plupart des activités de plein air',
    bft: ['Calme', 'Très légère brise', 'Légère brise', 'Petite brise', 'Jolie brise', 'Bonne brise', 'Vent frais', 'Grand frais', 'Coup de vent', 'Fort coup de vent', 'Tempête', 'Violente tempête', 'Ouragan'],
    compassN: 'N',
    compassE: 'E',
    compassS: 'S',
    compassW: 'O',
    sunTitle: '☀️ Soleil &amp; UV',
    sunRise: 'Lever',
    sunSet: 'Coucher',
    sunDaylen: 'Durée du jour',
    uvNow: 'Indice UV maintenant :',
    uvMax: "Max aujourd'hui :",
    uvAdviceHigh: '🧴 Crème solaire forte — évitez le midi',
    uvAdviceMid: '🧴 Bien se protéger — attention',
    uvAdviceLow: '☀️ Crème solaire si sortie prolongée',
    uvAdviceNone: '✅ UV faible — pas de protection supplémentaire',
    duration: (h, m) => `${h} h ${m} min`,
    hoursShort: 'h',
    hourlyTitle: '🕐 Prochaines 24 heures',
    dailyTitle: '📅 Prévisions 7 jours',
    today: "Aujourd'hui",
    tomorrow: 'Demain',
    dry: 'sec',
    airTitle: '🌬️ Air &amp; pollen',
    ...
    aqiPoor: 'Médiocre',
    aqiVeryPoor: 'Mauvais',
    aqiExtreme: 'Très mauvais',
    ozone: 'Ozone',
    pollenLead: (lvl) => `Rhume des foins : ${lvl}`,
    pollenNa: '—',
    pollenNone: 'nul',
    pollenLow: 'faible',
    ...
    flagDescs: flagMap([
      ...
      'Prudence — vent ou vagues en hausse',
      'Déconseillé — vent fort ou vagues hautes',
      'Dangereux — tempête ou vagues très hautes',
      'Pas de surveillance',
    ]),
    flagMeta: (bft, wave) => `Vent ${bft} Bft · vagues ${wave} m`,
    flagSourceIndicative: 'Source : indicatif (vent + hauteur des vagues)',
    flagSourceLifeguard: 'Source : poste de secours (en direct)',
    tideTitle: (water) => `🌊 Marées${water}`,
    highWater: 'Marée haute',
    lowWater: 'Marée basse',
    tideLevel: (sign, cm) => `${sign}${cm} cm NAP`,
    tideSource: (station) => `Source : Rijkswaterstaat (${station})`,
    waterNames: { Noordzee: 'Mer du Nord' },
    seaTitle: '🏖️ Mer &amp; surf',
    seaTemp: 'Temp. eau',
    waveHeight: 'Hauteur vagues',
    swell: 'Houle',
    current: 'Courant',
    gusts: 'Rafales',
    noSeaData: 'Aucune donnée maritime',
    kmh: 'km/h',
    footerSources: 'Sources :',
    footerRefresh: 'Actualisé toutes les 10 minutes',
